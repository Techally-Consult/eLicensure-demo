...
- **Wizard:** Single multi-step flow for New; for Renewal/Variation/Additional service, `/apply?type=renewal|variation|additional` shows **application list** first, then type-specific flow (Renewal: detail + “Request renewal” → new RENEWAL app; Variation: full edit; Additional: partial edit via `?mode=additionalService`). Supports create and edit.
